...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String name,  String email,  String phone,  String password,  String address,  String age)?  userRegister,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _UserRegister() when userRegister != null:
return userRegister(_that.name,_that.email,_that.phone,_that.password,_that.address,_that.age);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String name,  String email,  String phone,  String password,  String address,  String age)  userRegister,}) {final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String name,  String email,  String phone,  String password,  String address,  String age)?  userRegister,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _UserRegister() when userRegister != null:
return userRegister(_that.name,_that.email,_that.phone,_that.password,_that.address,_that.age);case _:
...
class _UserRegister implements RegisterBlocEvent {
  const _UserRegister({required this.name, required this.email, required this.phone, required this.password, required this.address, required this.age});
...
@override
int get hashCode => Object.hash(runtimeType,name,email,phone,password,address,age);

@override
String toString() {
  return 'RegisterBlocEvent.userRegister(name: $name, email: $email, phone: $phone, password: $password, address: $address, age: $age)';
}
...
@useResult
$Res call({
 String name, String email, String phone, String password, String address, String age
});
...
/// Create a copy of RegisterBlocEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? name = null,Object? email = null,Object? phone = null,Object? password = null,Object? address = null,Object? age = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( PatientRegModel response)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( PatientRegModel response)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( PatientRegModel response)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Success() when success != null:
...
class _Success implements RegisterBlocState {
 ...
 final  PatientRegModel response;
